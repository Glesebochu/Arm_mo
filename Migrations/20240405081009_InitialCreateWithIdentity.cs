    ...
    public partial class InitialCreateWithIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Pictures", x => x.ProfilePictureId);
                    table.ForeignKey(
                        name: "FK_Pictures_Meditators_MeditatorId",
                        column: x => x.MeditatorId,
                        principalTable: "Meditators",
                        principalColumn: "MeditatorId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StagePictures", x => x.StagePictureId);
                    table.ForeignKey(
                        name: "FK_StagePictures_Stages_StageId",
                        column: x => x.StageId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pictures_MeditatorId",
                table: "Pictures",
                column: "MeditatorId");

            migrationBuilder.CreateIndex(
                name: "IX_StagePictures_StageId",
                table: "StagePictures",
                column: "StageId",
                unique: true);
        }
