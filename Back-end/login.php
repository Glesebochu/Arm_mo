...
if ($result->num_rows > 0) {
  // The database exists, continue with the login process
  ...
  // The database does not exist, redirect to the signup page
  header("Location: ../Front-end/Signup/signup.html");
  exit;
}
?>