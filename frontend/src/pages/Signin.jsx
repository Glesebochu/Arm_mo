...
const Signin = () => {
  ...
  return (
    <div className="container flex h-screen w-screen flex-col items-center justify-center">
      <h2 className="mb-5 font-k2d">Sign in to <span className="font-bold">Arm'mo</span></h2>
      <div className="relative overflow-hidden grid gap-6 bg-white w-full max-w-[390px] shadow-input rounded-tl-none rounded-2xl p-8 mx-4">
        <div className="grid gap-2 z-50">
          <div className="grid gap-1">
            <Label className="font-k2d" htmlFor="email">
              Email
            </Label>
            <AnimatedInput
              id="email"
          ...
          <div className="grid gap-1">
            <Label className="font-k2d" htmlFor="password">
              Password
            </Label>
            <AnimatedInput
              id="password"
        ...
        <Button onClick={handleSubmit} className="font-k2d w-full">
          Sign In
        </Button>
